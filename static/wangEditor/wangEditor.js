...
_e(function (E, $) {
    ...
    MenuContainer.fn.init = function () {
        var self = this;
        var $menuContainer = $('<div class="wangEditor-menu-container clearfix2"></div>');
...
_e(function (E, $) {
    ...
    MenuContainer.fn._addGroup = function (groupIdx) {
        ...
        if (!this.$currentGroup || this.currentGroupIdx !== groupIdx) {
            $menuGroup = $('<div class="menu-group clearfix2"></div>');
    ...
    MenuContainer.fn._addOneMenu = function (menu) {
        ...
        var $item = $('<div class="menu-item clearfix2"></div>');
        $menuSelected.hide();
...
_e(function (E, $) {
    ...
    DropList.fn.initDOM = function () {
        ...
        var $list = $('<div class="wangEditor-drop-list clearfix2"></div>');
...
_e(function (E, $) {
    ...
    DropPanel.fn.initDOM = function () {
        ...
        var $panel = $('<div class="wangEditor-drop-panel clearfix2"></div>');
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        // 创建 dropPanel
        var $content = $('<div></div>');
        var $div1 = $('<div style="margin:20px 10px;" class="clearfix2"></div>');
        var $div2 = $div1.clone();
